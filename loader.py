...
DATA_PATH = 'D:\\indoorCVPR\\data\\'
TRAIN_DATA = 'D:\\indoorCVPR\\data\\train_img\\'
TEST_DATA = 'D:\\indoorCVPR\\data\\test_img\\'
TRAIN_IMG_FILE = 'D:\\indoorCVPR\\data\\train_img.txt'
TEST_IMG_FILE = 'D:\\indoorCVPR\\data\\test_img.txt'
TRAIN_LABEL_FILE = 'D:\\indoorCVPR\\data\\train_label.txt'
TEST_LABEL_FILE = 'D:\\indoorCVPR\\data\\test_label.txt'

NLABELS = 2

batch_size = 4

# decidere come mettere la dimensione delle immagini
...
print("training init")
dset_train = data_processing.DatasetProcessing(
    DATA_PATH, TRAIN_DATA, TRAIN_IMG_FILE, TRAIN_LABEL_FILE, transformations)

print("testing init")
dset_test = data_processing.DatasetProcessing(

...
class DatasetInfo():
    def __init__(self, root_path='dataset_ade20k_filtered/annotations', scene_file='data_processing/scenes.txt', obj_classes_file='data_processing/interesting_objects.txt'):
